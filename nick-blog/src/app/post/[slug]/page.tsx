...
import { getAllPostMetas, getPostBySlug, resolveAssetUrl } from "@/lib/server/posts";
      ...
      <article className="prose mx-auto py-8">
        ...
        <ReactMarkdown
          ...
          components={{
            img({ node, ...props }) {
              const resolvedSrc =
                typeof props.src === "string" ? resolveAssetUrl(meta, props.src) : undefined;
              return <img {...props} src={resolvedSrc ?? (props.src as any)} alt={props.alt ?? ""} />;
            },
            a({ node, ...props }) {
              // 外部リンクは別タブ
              const isExternal =
